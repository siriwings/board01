...
class BoardPost extends Component {
    ...
    handlePost(event) {
        ...
        return this.props.articlePostRequest(title, contents, publish).then(
            () => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        articlePostRequest: (title, contents, publish) => {
            return dispatch(articlePostRequest(title, contents, publish));
        }
    };
};
